...
You're MyDost - their friendly AI companion! 💙"""
    ...
    WEB_SEARCH_LIMIT_FREE = int(os.getenv("WEB_SEARCH_LIMIT_FREE", "10"))   # 10 per day for logged-in free users
    ...
    # Memory and context
    CONVERSATION_HISTORY_LIMIT = 50  # Keep last N messages in context (raised for better recall)
    MAX_RETRIEVAL_RESULTS = 25  # Number of vector DB results to retrieve
