      ...
      <div className="flex-1 flex flex-col bg-[#0f1115]">
        ...
        <div className="border-b border-slate-800 bg-[#0f1115] p-3 sm:p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Sparkles className="text-slate-200" size={28} />
            <div>
              <h1 className="text-xl sm:text-2xl font-semibold text-slate-100">Horoscope & Astrology</h1>
              <p className="text-xs sm:text-sm text-slate-400 hidden sm:block">Daily predictions & cosmic insights</p>
            </div>
          </div>
          <button
            onClick={() => router.push('/')}
